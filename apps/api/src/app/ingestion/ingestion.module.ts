...
@Module({
  ...
  providers: [OsmImportService, GoogleEnrichmentService, EventIngestionService, EventCronService, FacetMapperService, GeminiEnrichmentService, VoiceEnrichmentService, CooccurrenceService],
  exports: [OsmImportService, GoogleEnrichmentService, EventIngestionService, FacetMapperService, GeminiEnrichmentService, VoiceEnrichmentService, CooccurrenceService],
})
