...
const MIGRATIONS: { name: string; sql: string }[] = [
  { name: '001', sql: `CREATE EXTENSION IF NOT EXISTS postgis; CREATE EXTENSION IF NOT EXISTS "uuid-ossp";` },
